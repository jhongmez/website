{{-- navbar fixed --}}
<nav class="navbar navbar-expand-lg fixed-top navbar-light shadow-sm p-3 mb-5 bg-white">
	<div class="container">
		<a class="navbar-brand" href="#">
			<img src="{{ asset('images/logo.png') }}" class="logotype" alt="industrias maviltex s.a.s">
		</a>
